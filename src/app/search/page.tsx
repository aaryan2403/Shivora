    ...
    <main className="min-h-screen bg-obsidian text-creme selection:bg-ash selection:text-obsidian pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-12">
        <div className="text-center mb-16">
          ...
          <h1 className="font-cinzel text-3xl md:text-5xl mb-6">"{query}"</h1>
        ...
        {searchResults.length === 0 && (
           <div className="text-center py-32">
             ...
             <Link 
               href="/collections"
               className="text-creme border-b border-creme pb-1 hover:opacity-70 transition-opacity text-xs uppercase tracking-[0.2em]"
             >
