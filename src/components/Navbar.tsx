...
export default function Navbar() {
  ...
  return (
    ...
    className={`${isHome ? "fixed" : "absolute"} top-0 w-full ${NAVBAR_THICKNESS} px-6 md:px-10 flex justify-between items-center z-[100] text-creme transition-all duration-300 bg-gradient-to-b from-primary/80 to-transparent`}
    >
